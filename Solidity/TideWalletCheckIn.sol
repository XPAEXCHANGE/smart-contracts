...
contract TideWalletCheckIn is StandardToken {
    // metadata
    mapping(address => uint256) checkInBlock;
        ...
        payable
    {
        ...
        uint256 gasReward = safeMul(msg.value, gasPrice);
