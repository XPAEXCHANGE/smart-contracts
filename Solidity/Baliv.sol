...
contract Baliv is SafeMath, Authorization {
    ...
    */
    ...
    /* External Function
        ...
        function agentMakeOrder(address fromToken_, address toToken_, uint256 price_, uint256 amount_, address representor_) external payable returns(bool);
    ...
    */
        ...
        public
    {
        ...
        currUser = getNextOrderUser(fromToken_, toToken_, price_, address(0));
        if(currUser == address(0)) {
